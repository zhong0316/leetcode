...
public class OnesAndZeroes {
    ...
    public int findMaxForm(String[] strs, int m, int n) {
        ...
        //then we need to find what combination of strings in strs gives us the maximum net value
        //say, dp[i][m][n] <- number of strings using m zeroes, n ones considering only first i strings in strs
